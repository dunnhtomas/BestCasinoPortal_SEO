...
use BestCasinoPortal\Services\AuthService;
...
final readonly class AuthController
{
    ...
    public function login(ServerRequestInterface $request): ResponseInterface
    {
        ...
        try {
            ...
            $loginDto = LoginDto::fromRequest($body);
            ...
            return $this->apiResponse->success($authResult, 200, [
                'response_time_ms' => round($responseTime, 2)
            ]);
        ...
        } catch (\BestCasinoPortal\Exceptions\AuthenticationException $e) {
    ...
    public function register(ServerRequestInterface $request): ResponseInterface
    {
        ...
        try {
            $body = $request->getParsedBody() ?? [];
            $registerDto = RegisterDto::fromRequest($body);
            ...
            return $this->apiResponse->success($authResult, 201, [
                'response_time_ms' => round($responseTime, 2)
            ]);
